...
def glow_node_group(context, operator, group_name):
    #enable use nodes
    ...
    #Socket Image
    image_socket_1 = glow.interface.new_socket(name = "Image", in_out='INPUT', socket_type = 'NodeSocketColor')
    image_socket_1.default_value = (1.0, 1.0, 1.0, 1.0)
    image_socket_1.attribute_domain = 'POINT'
    image_socket_1.description = "Standard color input"

    #Socket Quality
    quality_socket = glow.interface.new_socket(name = "Quality", in_out='INPUT', socket_type = 'NodeSocketFloat')
    ...
    #Socket Global Fac
    global_fac_socket = glow.interface.new_socket(name = "Global Fac", in_out='INPUT', socket_type = 'NodeSocketFloat')
    ...
    global_fac_socket.description = "Controls the amount of mixing between the given image and the glow effect"

    #Socket Streaks Fac
    streaks_fac_socket = glow.interface.new_socket(name = "Streaks Fac", in_out='INPUT', socket_type = 'NodeSocketFloat')
    ...
    streaks_fac_socket.description = "Controls the amount of mixing between the given image and the streak effect"
    ...
    #Socket Threshold
    threshold_socket = glow.interface.new_socket(name = "Threshold", in_out='INPUT', socket_type = 'NodeSocketFloat', parent = bloom_panel)
    ...
    threshold_socket.description = "Pixels brighter than this value will be affected by the glare filter"

    #Socket Size
    size_socket = glow.interface.new_socket(name = "Size", in_out='INPUT', socket_type = 'NodeSocketFloat', parent = bloom_panel)
    ...
    #Socket Bloom
    bloom_socket = glow.interface.new_socket(name = "Bloom", in_out='INPUT', socket_type = 'NodeSocketColor', parent = bloom_panel)
    ...
    #Socket Iterations
    iterations_socket = glow.interface.new_socket(name = "Iterations", in_out='INPUT', socket_type = 'NodeSocketFloat', parent = streaks_panel)
    ...
    color_modulation_socket = glow.interface.new_socket(name = "Color Modulation", in_out='INPUT', socket_type = 'NodeSocketFloat', parent = streaks_panel)
    ...
    color_modulation_socket.description = "Used for Streaks and Ghosts to create a special dispersion effect."

    #Socket Threshold
    threshold_socket_1 = glow.interface.new_socket(name = "Threshold", in_out='INPUT', socket_type = 'NodeSocketFloat', parent = streaks_panel)
    ...
    threshold_socket_1.description = "Pixels brighter than this value will be affected by the glare filter"

    #Socket Streaks
    streaks_socket = glow.interface.new_socket(name = "Streaks", in_out='INPUT', socket_type = 'NodeSocketFloat', parent = streaks_panel)
    ...
    #Socket Angle Offset
    angle_offset_socket = glow.interface.new_socket(name = "Angle Offset", in_out='INPUT', socket_type = 'NodeSocketFloat', parent = streaks_panel)
    ...
    #Socket Streaks
    streaks_socket_1 = glow.interface.new_socket(name = "Streaks", in_out='INPUT', socket_type = 'NodeSocketColor', parent = streaks_panel)
    ...
    ggi_streaks.color = COLORS_DICT["DARK_GRAY"]
    ...
    g_add_00.color = COLORS_DICT["BROWN"]
    ...
    g_add_01.color = COLORS_DICT["BROWN"]
    ...
    g_bloom_high.color = COLORS_DICT["DARK_PURPLE"]
    ...
    g_bloom_low.color = COLORS_DICT["DARK_PURPLE"]
    ...
    g_streaks_high.color = COLORS_DICT["DARK_PURPLE"]
    ...
    g_streaks_low.color = COLORS_DICT["DARK_PURPLE"]
    ...
    g_bloom_high____low.color = (0.27887165546417236, 0.4313916563987732, 0.31700167059898376)
    ...
    g_streaks_high____low.color = (0.2788630723953247, 0.43140727281570435, 0.31698769330978394)
    ...
    ggi_image.color = COLORS_DICT["DARK_GRAY"]
    ...
    ggi_global_fac.color = COLORS_DICT["DARK_GRAY"]
    ...
    ggi_streaks_fac.color = COLORS_DICT["DARK_GRAY"]
    ...
    ggi_bloom.color = COLORS_DICT["DARK_GRAY"]
