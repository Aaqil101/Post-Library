...
def vignette_basic_node_group(context, operator, group_name) -> NodeTree:
    # enable use nodes
    ...
    # Socket Image
    image_socket = vignette_basic.interface.new_socket(
    ...
    # Socket Amount
    amount_socket = vignette_basic.interface.new_socket(
    ...
    # Socket Distortion
    distortion_socket = vignette_basic.interface.new_socket(
    ...
    vb_group_output.color = Color.DARK_GRAY
    ...
    vb_group_input.color = Color.DARK_GRAY
    ...
    vb_blur.color = Color.DARK_PURPLE
    ...
    vb_greater_than.color = Color.DARK_BLUE
    ...
    vb_lens_distortion.color = Color.LIGHT_BLUE
