...
def contrast_node_group(context, operator, group_name) -> NodeTree:
    # enable use nodes
    ...
    # contrast interface
    # Socket Image
    image_socket = contrast.interface.new_socket(
    ...
    # Socket Image
    image_socket_1 = contrast.interface.new_socket(
    ...
    # Socket Fac
    fac_socket = contrast.interface.new_socket(
    ...
    # Socket Size X
    size_x_socket = contrast.interface.new_socket(
    ...
    # Socket Size Y
    size_y_socket = contrast.interface.new_socket(
    ...
    c_group_output.color = Color.DARK_GRAY
    ...
    c_group_input.color = Color.DARK_GRAY
    ...
    c_blur.color = Color.DARK_PURPLE
