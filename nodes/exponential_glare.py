...
def exponential_glare_node_group(context, operator, group_name):
    #enable use nodes
    ...
    #Socket Image
    image_socket = exponential_glare.interface.new_socket(name = "Image", in_out='OUTPUT', socket_type = 'NodeSocketColor')
    image_socket.default_value = (1.0, 1.0, 1.0, 1.0)
    image_socket.attribute_domain = 'POINT'

    #Socket Image
    image_socket_1 = exponential_glare.interface.new_socket(name = "Image", in_out='INPUT', socket_type = 'NodeSocketColor')
    image_socket_1.default_value = (1.0, 1.0, 1.0, 1.0)
    image_socket_1.attribute_domain = 'POINT'

    #Socket Strength
    strength_socket = exponential_glare.interface.new_socket(name = "Strength", in_out='INPUT', socket_type = 'NodeSocketFloat')
    ...
    group_input.color = COLORS_DICT["DARK_GRAY"]
    ...
    blur_2p.color = COLORS_DICT["DARK_PURPLE"]
    blur_2p.hide = True
    ...
    eg_add_00.color = COLORS_DICT["BROWN"]
    eg_add_00.hide = True
    ...
    eg_add_01.color = COLORS_DICT["BROWN"]
    eg_add_01.hide = True
    ...
    blur_4p.color = COLORS_DICT["DARK_PURPLE"]
    blur_4p.hide = True
    ...
    blur_8p.color = COLORS_DICT["DARK_PURPLE"]
    blur_8p.hide = True
    ...
    blur_16p.color = COLORS_DICT["DARK_PURPLE"]
    blur_16p.hide = True
    ...
    blur_32p.color = COLORS_DICT["DARK_PURPLE"]
    blur_32p.hide = True
    ...
    blur_64p.color = COLORS_DICT["DARK_PURPLE"]
    blur_64p.hide = True
    ...
    blur_128p.color = COLORS_DICT["DARK_PURPLE"]
    blur_128p.hide = True
    ...
    blur_256p.color = COLORS_DICT["DARK_PURPLE"]
    blur_256p.hide = True
    ...
    blur_512p.color = COLORS_DICT["DARK_PURPLE"]
    blur_512p.hide = True
    ...
    eg_add_02.color = COLORS_DICT["BROWN"]
    eg_add_02.hide = True
    ...
    eg_add_03.color = COLORS_DICT["BROWN"]
    eg_add_03.hide = True
    ...
    eg_add_04.color = COLORS_DICT["BROWN"]
    eg_add_04.hide = True
    ...
    eg_add_05.color = COLORS_DICT["BROWN"]
    eg_add_05.hide = True
    ...
    eg_add_06.color = COLORS_DICT["BROWN"]
    eg_add_06.hide = True
    ...
    eg_add_07.color = COLORS_DICT["BROWN"]
    eg_add_07.hide = True
    ...
    eg_add_08.color = COLORS_DICT["BROWN"]
    eg_add_08.hide = True
    ...
    eg_mix.color = COLORS_DICT["BROWN"]
