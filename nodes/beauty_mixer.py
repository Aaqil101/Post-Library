...
def diffuse_node_group() -> NodeTree:
    ...
    # diffuse interface
    # Socket Diff
    diff_socket = diffuse.interface.new_socket(
        name="Diff", in_out="OUTPUT", socket_type="NodeSocketColor"
    )
    diff_socket.default_value = (1.0, 1.0, 1.0, 1.0)
    diff_socket.attribute_domain = "POINT"

    # Socket DiffDir
    diffdir_socket = diffuse.interface.new_socket(
        name="DiffDir", in_out="INPUT", socket_type="NodeSocketColor"
    )
    ...
    # Socket DiffInd
    diffind_socket = diffuse.interface.new_socket(
        name="DiffInd", in_out="INPUT", socket_type="NodeSocketColor"
    )
    ...
    # Socket DiffCol
    diffcol_socket = diffuse.interface.new_socket(
        name="DiffCol", in_out="INPUT", socket_type="NodeSocketColor"
    )
...
def glossy_node_group() -> NodeTree:
    ...
    # glossy interface
    # Socket Gloss
    gloss_socket = glossy.interface.new_socket(
        name="Gloss", in_out="OUTPUT", socket_type="NodeSocketColor"
    )
    gloss_socket.default_value = (1.0, 1.0, 1.0, 1.0)
    gloss_socket.attribute_domain = "POINT"

    # Socket GlossDir
    glossdir_socket = glossy.interface.new_socket(
        name="GlossDir", in_out="INPUT", socket_type="NodeSocketColor"
    )
    ...
    # Socket GlossInd
    glossind_socket = glossy.interface.new_socket(
        name="GlossInd", in_out="INPUT", socket_type="NodeSocketColor"
    )
    ...
    # Socket GlossCol
    glosscol_socket = glossy.interface.new_socket(
        name="GlossCol", in_out="INPUT", socket_type="NodeSocketColor"
    )
...
def transmission_node_group():
    transmission = bpy.data.node_groups.new(
        type="CompositorNodeTree", name="Transmission"
    )
    ...
    # Socket Trans
    trans_socket = transmission.interface.new_socket(
        name="Trans", in_out="OUTPUT", socket_type="NodeSocketColor"
    )
    trans_socket.default_value = (1.0, 1.0, 1.0, 1.0)
    trans_socket.attribute_domain = "POINT"

    # Socket TransDir
    transdir_socket = transmission.interface.new_socket(
        name="TransDir", in_out="INPUT", socket_type="NodeSocketColor"
    )
    ...
    # Socket TransInd
    transind_socket = transmission.interface.new_socket(
        name="TransInd", in_out="INPUT", socket_type="NodeSocketColor"
    )
    ...
    # Socket TransCol
    transcol_socket = transmission.interface.new_socket(
        name="TransCol", in_out="INPUT", socket_type="NodeSocketColor"
    )
    ...
    # Set dimensions
    transmission_group_output.width, transmission_group_output.height = (
        174.54278564453125,
        100.0,
    )
    transmission_group_input.width, transmission_group_input.height = (
        170.42803955078125,
        100.0,
    )
    ...
    transmission.links.new(
        transmission_group_input.outputs[2], multiply_transmission.inputs[2]
    )

    # transmission_group_input.TransInd -> add_transmission.Image
    transmission.links.new(
        transmission_group_input.outputs[1], add_transmission.inputs[2]
    )

    # transmission_group_input.TransDir -> add_transmission.Image
    transmission.links.new(
        transmission_group_input.outputs[0], add_transmission.inputs[1]
    )

    # multiply_transmission.Image -> transmission_group_output.Trans
    transmission.links.new(
        multiply_transmission.outputs[0], transmission_group_output.inputs[0]
    )
...
def volume_node_group():
    ...
    # volume interface
    # Socket Volume
    volume_socket = volume.interface.new_socket(
        name="Volume", in_out="OUTPUT", socket_type="NodeSocketColor"
    )
    volume_socket.default_value = (1.0, 1.0, 1.0, 1.0)
    volume_socket.attribute_domain = "POINT"

    # Socket VolumeDir
    volumedir_socket = volume.interface.new_socket(
        name="VolumeDir", in_out="INPUT", socket_type="NodeSocketColor"
    )
    ...
    # Socket VolumeInd
    volumeind_socket = volume.interface.new_socket(
        name="VolumeInd", in_out="INPUT", socket_type="NodeSocketColor"
    )
...
def beautymixer_node_group(context, operator, group_name):
    ...
    # Socket Diff
    diff_socket_1 = beautymixer.interface.new_socket(
        name="Diff", in_out="OUTPUT", socket_type="NodeSocketColor"
    )
    ...
    # Socket Gloss
    gloss_socket_1 = beautymixer.interface.new_socket(
        name="Gloss", in_out="OUTPUT", socket_type="NodeSocketColor"
    )
    ...
    # Socket Trans
    trans_socket_1 = beautymixer.interface.new_socket(
        name="Trans", in_out="OUTPUT", socket_type="NodeSocketColor"
    )
    ...
    # Socket Volume
    volume_socket_1 = beautymixer.interface.new_socket(
        name="Volume", in_out="OUTPUT", socket_type="NodeSocketColor"
    )
    ...
    # Socket DiffDir
    diffdir_socket_1 = beautymixer.interface.new_socket(
        name="DiffDir",
        in_out="INPUT",
        socket_type="NodeSocketColor",
        parent=diffuse_panel,
    )
    ...
    # Socket DiffInd
    diffind_socket_1 = beautymixer.interface.new_socket(
        name="DiffInd",
        in_out="INPUT",
        socket_type="NodeSocketColor",
        parent=diffuse_panel,
    ...
    # Socket DiffCol
    diffcol_socket_1 = beautymixer.interface.new_socket(
        name="DiffCol",
        in_out="INPUT",
        socket_type="NodeSocketColor",
        parent=diffuse_panel,
    ...
    # Socket GlossDir
    glossdir_socket_1 = beautymixer.interface.new_socket(
        name="GlossDir",
        in_out="INPUT",
        socket_type="NodeSocketColor",
        parent=glossy_panel,
    ...
    # Socket GlossInd
    glossind_socket_1 = beautymixer.interface.new_socket(
        name="GlossInd",
        in_out="INPUT",
        socket_type="NodeSocketColor",
        parent=glossy_panel,
    ...
    # Socket GlossCol
    glosscol_socket_1 = beautymixer.interface.new_socket(
        name="GlossCol",
        in_out="INPUT",
        socket_type="NodeSocketColor",
        parent=glossy_panel,
    ...
    # Panel Transmission
    transmission_panel = beautymixer.interface.new_panel(
        "Transmission", default_closed=True
    )
    transmission_panel.description = "For mixing transmission pass"

    # Socket TransDir
    transdir_socket_1 = beautymixer.interface.new_socket(
        name="TransDir",
        in_out="INPUT",
        socket_type="NodeSocketColor",
        parent=transmission_panel,
    )
    ...
    # Socket TransInd
    transind_socket_1 = beautymixer.interface.new_socket(
        name="TransInd",
        in_out="INPUT",
        socket_type="NodeSocketColor",
        parent=transmission_panel,
    ...
    # Socket TransCol
    transcol_socket_1 = beautymixer.interface.new_socket(
        name="TransCol",
        in_out="INPUT",
        socket_type="NodeSocketColor",
        parent=transmission_panel,
    ...
    # Socket VolumeDir
    volumedir_socket_1 = beautymixer.interface.new_socket(
        name="VolumeDir",
        in_out="INPUT",
        socket_type="NodeSocketColor",
        parent=volume_panel,
    ...
    # Socket VolumeInd
    volumeind_socket_1 = beautymixer.interface.new_socket(
        name="VolumeInd",
        in_out="INPUT",
        socket_type="NodeSocketColor",
        parent=volume_panel,
