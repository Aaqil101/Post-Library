...
def vignette_node_group(context, operator, group_name, image_path):
	...
	#vignette interface
	#Socket image
    image_socket = vignette.interface.new_socket(name = "image", in_out='OUTPUT', socket_type = 'NodeSocketColor')
    ...
    vig_group_output.color = COLORS_DICT["DARK_GRAY"]
    ...
    vig_group_input.color = COLORS_DICT["DARK_GRAY"]
