...
def chromatic_aberration_node_group(context, operator, group_name):
    ...
    # Socket Image
    image_socket = chromatic_aberration.interface.new_socket(
    ...
    # Socket Image
    image_socket_1 = chromatic_aberration.interface.new_socket(
    ...
    ca_directional_blur_00.color = Color.DARK_PURPLE
    ...
    ca_directional_blur_01.color = Color.DARK_PURPLE
    ...
    ca_directional_blur_02.color = Color.DARK_PURPLE
    ...
    ca_blur_02.color = Color.DARK_PURPLE
    ...
    ca_directional_blur_00.width, ca_directional_blur_00.height = (
        153.22442626953125,
        100.0,
    )
    ca_directional_blur_01.width, ca_directional_blur_01.height = (
        156.596923828125,
        100.0,
    )
    ca_directional_blur_02.width, ca_directional_blur_02.height = (
        155.35626220703125,
        100.0,
    )
    ...
    chromatic_aberration.links.new(
        ca_group_input.outputs[0], ca_separate_color.inputs[0]
    )

    # ca_separate_color.Red -> ca_directional_blur_00.Image
    chromatic_aberration.links.new(
        ca_separate_color.outputs[0], ca_directional_blur_00.inputs[0]
    )

    # ca_separate_color.Green -> ca_directional_blur_01.Image
    chromatic_aberration.links.new(
        ca_separate_color.outputs[1], ca_directional_blur_01.inputs[0]
    )

    # ca_separate_color.Blue -> ca_directional_blur_02.Image
    chromatic_aberration.links.new(
        ca_separate_color.outputs[2], ca_directional_blur_02.inputs[0]
    )

    # ca_directional_blur_00.Image -> ca_blur_00.Image
    chromatic_aberration.links.new(
        ca_directional_blur_00.outputs[0], ca_blur_00.inputs[0]
    )

    # ca_directional_blur_01.Image -> ca_blur_01.Image
    chromatic_aberration.links.new(
        ca_directional_blur_01.outputs[0], ca_blur_01.inputs[0]
    )

    # ca_directional_blur_02.Image -> ca_blur_02.Image
    chromatic_aberration.links.new(
        ca_directional_blur_02.outputs[0], ca_blur_02.inputs[0]
    )
    ...
    chromatic_aberration.links.new(
        ca_separate_color.outputs[3], ca_reroute_00.inputs[0]
    )
    ...
    chromatic_aberration.links.new(
        ca_combine_color.outputs[0], ca_group_output.inputs[0]
    )
