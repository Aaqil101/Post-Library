...
def halation_node_group(context, operator, group_name) -> NodeTree:
    # enable use nodes
    ...
    # halation interface
    # Socket Image
    image_socket = halation.interface.new_socket(
    ...
    # Socket Image
    image_socket_1 = halation.interface.new_socket(
    ...
    # Socket Size X
    size_x_socket = halation.interface.new_socket(
    ...
    # Socket Size Y
    size_y_socket = halation.interface.new_socket(
        name="Size Y", in_out="INPUT", socket_type="NodeSocketFloat"
    )
    ...
    # Socket Fac
    fac_socket = halation.interface.new_socket(
    ...
    h_group_output.color = Color.DARK_GRAY
    ...
    h_group_input.color = Color.DARK_GRAY
    ...
    h_blur.color = Color.DARK_PURPLE
    ...
    h_combine_color.color = Color.DARK_BLUE
    ...
    h_separate_color.color = Color.DARK_BLUE
    ...
    h_color_ramp.color = Color.DARK_BLUE
    ...
    h_color_balance.color = Color.BROWN
    h_color_balance.correction_method = "LIFT_GAMMA_GAIN"
    h_color_balance.gain = mathutils.Color(
        (1.0625041723251343, 0.9746971726417542, 0.9597135186195374)
    )
    h_color_balance.gamma = mathutils.Color(
        (1.0547555685043335, 0.9844463467597961, 0.95830899477005)
    )
